...
class Profile
{
    ...
    {
        $dateTimeOB = ($this->dob)->format("Y-m-d H:i:s");
        return "UPDATE profile SET `name`='$this->name', `gender`='$this->gender', `description`='$this->description',  `datetime_of_birth`='$dateTimeOB' WHERE `id`='$this->id'";
    }
