...
class Seeking {
    ...
    // Constructor
    public function __construct($minAge, $maxAge, $gender, $location, $interests, $relationshipType) {
        $this->minAge = $minAge;
        $this->maxAge = $maxAge;
        $this->gender = $gender;
...
$input1 = strtolower($_GET["input1"]); // Assuming you get input from a form or URL parameter
$input2 = strtolower($_GET["input2"]); // Assuming you get input from a form or URL parameter
...
//> Example usage
$seekingPreferences = new Seeking(18, 30, 'female', 'New York', ['music', 'sports'], 'serious');
echo "Min Age: " . $seekingPreferences->getMinAge() . "<br>";
echo "Max Age: " . $seekingPreferences->getMaxAge() . "<br>";
echo "Gender: " . $seekingPreferences->getGender() . "<br>";
echo "Location: " . $seekingPreferences->getLocation() . "<br>";
echo "Interests: " . implode(", ", $seekingPreferences->getInterests()) . "<br>";
echo "Relationship Type: " . $seekingPreferences->getRelationshipType() . "<br";
